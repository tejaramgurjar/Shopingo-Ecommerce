...
function Faq() {
  ...
  <div className="row justify-content-center">
    <div className="col-lg-10 classb">
      <b>PRIVACY POLICY FOR LAMENTIS SOFTWARE</b>
      <br />
      AT LAMENTIS, ACCESSIBLE FROM HTTPS://LAMENTIS.IN/, ONE OF OUR MAIN
      PRIORITIES IS THE PRIVACY OF OUR VISITORS. THIS PRIVACY POLICY DOCUMENT
      CONTAINS TYPES OF INFORMATION THAT IS COLLECTED AND RECORDED BY LAMENTIS
      AND HOW WE USE IT.
      <br />
      <br />
      ...
      AND/OR COLLECT IN LAMENTIS. THIS POLICY IS NOT APPLICABLE TO ANY
      ...
      new products, services, features, and functionality Communicate with you,
      ...
      website, and for marketing and promotional purposes Send you emails Find
      and prevent fraud
      <br />
      <br />
      <br />
      <b>Log Files</b>
      <br />
      LAMENTIS follows a standard procedure of using log files. These files log
      ...
      <br />
      Like any other website, LAMENTIS uses 'cookies'. These cookies are used to
      ...
      advertising partners of LAMENTIS.
      <br />
      Third-party ad servers or ad networks uses technologies like cookies,
      JavaScript, or Web Beacons that are used in their respective
      advertisements and links that appear on LAMENTIS, which are sent directly
      ...
      <br />
      Note that LAMENTIS has no access to or control over these cookies that are
      ...
      <br />
      LAMENTIS's Privacy Policy does not apply to other advertisers or websites.
      ...
      <br />
      LAMENTIS does not knowingly collect any Personal Identifiable Information
