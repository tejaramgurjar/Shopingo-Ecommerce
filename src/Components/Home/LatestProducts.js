              ...
              >
                ...
                <li className="nav-item" role="presentation">
                  <button
                    className="nav-link"
                    data-bs-toggle="pill"
                    data-bs-target="#trending-product"
                    type="button"
                  >
                    Trending
                  </button>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/new-arrival/03.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/new-arrival/09.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/new-arrival/10.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/best-sellar/03.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  ...
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/best-sellar/04.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/best-sellar/05.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/trending-product/02.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  ...
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="javascript:;">
                      <img
                        src="assets/images/trending-product/03.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/trending-product/05.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/special-offer/01.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/special-offer/02.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
              ...
              <div className="col">
                <div className="card">
                  <div className="position-relative overflow-hidden">
                    ...
                    <Link to="product-details.html">
                      <img
                        src="assets/images/special-offer/05.webp"
                        className="card-img-top"
                        alt="..."
                      />
                    </Link>
